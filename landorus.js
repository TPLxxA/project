...
*/
console.log("jsbfiasbfiasduhfvubfdali");

window.onload = function() {

	console.log("GODVERDOMMEEEEEE!!");
	// load all datasets
	d3.queue()
	...
	function pieChart(data) {
		...
		console.log("voor pie");
		var pie = d3.pie()
			.data(data)
		    .sort(null)
		    .value(function(d) { console.log(d.moves); return d.moves; });
		...
		// // what the hell mike please explain how this works
		...
		arc.append("path")
		    .attr("d", path)
		    .attr("fill", function(d) { console.log(d.data.moves); return color(d.data.moves); });

		arc.append("text")
			.attr("transform", function(d) { return "translate(" + label.centroid(d) + ")"; })
			.attr("dy", "0.35em")
			.text(function(d) { return d.data.moves; });
